...
module.exports.controller = (app, io, socket_list) => {
    ...
    const msg_success = "Đăng nhập thành công";
    const msg_fail = "Thất bại";
    const msg_invalidUser = "Tên người dùng và mật khẩu không hợp lệ";
    const msg_already_register = "email này đã đăng ký ";
    const msg_added_favorite = "thêm danh sách yêu thích thành công ";
    const msg_removed_favorite = "đã xóa danh sách yêu thích thành công ";
    const msg_invalid_item = "sản phẩm không hợp lệ";
    const msg_add_to_item = "sản phẩm được thêm vào giỏ hàng thành công";
    const msg_remove_to_cart = "loại bỏ giỏ hàng thành công"
    const msg_add_address = "địa chỉ được thêm thành công"
    const msg_update_address = "địa chỉ được cập nhật thành công"
    const msg_remove_address = "đã xóa địa chỉ thành công"

    const msg_add_payment_method = "phương thức thanh toán được thêm thành công"
    const msg_remove_payment_method = "đã xóa phương thức thanh toán thành công"
